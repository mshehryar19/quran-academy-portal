...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-600"><a href="{{ route('parent.billing.index') }}" class="underline">All children</a></p>
    </div>
        ...
        <table class="min-w-full text-sm">
            ...
            @foreach ($invoices as $inv)
                <tr class="border-b border-gray-100">
                    ...
                    <td class="px-3 py-2"><a href="{{ route('parent.billing.invoice.show', [$student, $inv]) }}" class="underline">Detail</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
