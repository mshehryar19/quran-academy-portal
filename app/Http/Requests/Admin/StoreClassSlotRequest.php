...
class StoreClassSlotRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('create', ClassSlot::class);
    }
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            ...
            $ns = Carbon::createFromFormat('H:i', $start)->format('H:i:s');
            $ne = Carbon::createFromFormat('H:i', $end)->format('H:i:s');
            if (ClassSlot::query()->where('start_time', $ns)->where('end_time', $ne)->exists()) {
